...
def tokenize_and_split_data(training_config, tokenizer):
  ...
  if use_hf:
    ...
    dataset = load_dataset(dataset_path, training_config, tokenizer)
  train_dataset = dataset["train"]
  test_dataset = dataset["test"]
  return train_dataset, test_dataset

# Tokenize and split data
def load_dataset(dataset_path, training_config, tokenizer):
    random.seed(42)
...
class Trainer(transformers.Trainer):
    ...
    def training_step(self, model, inputs, dummy):
